"""
Purpose: T_2 (ATRA analogues, CReM) step 3 — non-covalent docking of the surviving candidates.
Author: Mike Hallett (with Claude Code)
Date: 2026-07-28
Input: the latest D2 frame (post annotate-and-gate)
Output: D2 with `vina_affinity`; poses under append_only/
...
THIS APPROACH: inherits ATRA's chemotype, the lowest-novelty arm by design.
